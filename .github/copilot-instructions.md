...
- Auth & cookies: Many services depend on authentication stored in cookies. If you change auth flow, update `src/shared/api/client.ts` and `UsuarioService.getUsuario()` consistently.
