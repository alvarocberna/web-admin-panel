...
export function NavbarPublic({ equipo, servicios, articulos, testimonios }: Props) {
    ...
    const hasBg = scrolled || !TRANSPARENT_DEFAULT
    const positionClass = STICKY_ON_SCROLL ? 'fixed' : 'relative'
            ...
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-16">
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link href="/" className="shrink-0">
                        <img src="/images/img-logo-google.png" alt="Logo" className="h-10 w-auto object-contain" />
                    </Link>
